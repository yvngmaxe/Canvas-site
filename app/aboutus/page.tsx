      ...
      <PageLayout title="ABOUT US" subtitle="私たちについて">
        <div className={styles.wrap}>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.text}>
              広島が日本の教育シーンのアップデートを牽引する姿を体現します。AIの台頭・情報の可視化、急速に変化しつつある社会情勢の中で、教育の形も少しずつ変化します。成績によって区分される時代から、数値化できない個人の内側に秘められた何かに焦点をあてる時代へ。20歳までなんとなく生きる時代から、アツい「個」が自分を主張しあう時代へ。
            </p>
            <p className={styles.text}>
              弊社は小中高校生向けに身近な地域課題/社会課題を絡めた自主探究的キャリア教育を推進していきます。自分で考え、思考を言葉にまとめ、他人にプレゼンする。話し合い、修正し、意思決定する。この先、生きていくうえで不可欠な「生きる力」と「生きるための色」を持ち合わせたアツい「個」を養成します。
            </p>
          </section>
